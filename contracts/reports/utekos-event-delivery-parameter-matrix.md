...
| `page_view` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel is the sole browser owner and canonical Meta CAPI is the sole server owner. Meta-managed Signals Gateway mirrors Pixel delivery with the same event_id; no independent cbq bridge is active. Historical blocked rows remain excluded from blind replay. |
...
| `view_item` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel and canonical Meta CAPI are active with shared event_id. Meta-managed Signals Gateway mirrors Pixel delivery; the independent GTM cbq bridge is paused. |
...
| `add_to_cart` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel and canonical Meta CAPI are active for add_to_cart with shared event_id. Meta-managed Signals Gateway mirrors Pixel delivery; the independent GTM cbq bridge is paused. |
...
| `begin_checkout` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel and canonical Meta CAPI are active for begin_checkout with shared event_id. Meta-managed Signals Gateway mirrors Pixel delivery; the independent GTM cbq bridge is paused. |
