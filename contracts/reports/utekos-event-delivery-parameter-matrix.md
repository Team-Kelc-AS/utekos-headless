...
| `page_view` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned browser bridge dispatches one canonical Meta Pixel call and, when the consent-gated Signals Gateway SDK is enabled, one cbq call with the same event_id. Canonical Meta CAPI remains the server owner. The independent manual GTM cbq bridge stays paused, and historical blocked rows remain excluded from blind replay. |
...
| `page_view` | `active` | `snapchat` | snap_pixel (implemented; event-specific logical requirements) | snap_conversions_api_v3 (active; event-specific logical requirements) | Utekos-owned Snap Pixel and Conversions API v3 outbox are active. |
...
| `view_item` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned browser bridge dispatches one canonical Meta Pixel call and, when the consent-gated Signals Gateway SDK is enabled, one cbq call with the same event_id. Canonical Meta CAPI remains the server owner, and the independent manual GTM cbq bridge remains paused. |
...
| `view_item` | `active` | `snapchat` | snap_pixel (implemented; event-specific logical requirements) | snap_conversions_api_v3 (active; event-specific logical requirements) | Utekos-owned Snap Pixel and Conversions API v3 outbox are active. |
...
| `add_to_wishlist` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `add_to_cart` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned browser bridge dispatches one canonical Meta Pixel call and, when the consent-gated Signals Gateway SDK is enabled, one cbq call for add_to_cart with the same event_id. Canonical Meta CAPI remains the server owner, and the independent manual GTM cbq bridge remains paused. |
...
| `add_to_cart` | `active` | `snapchat` | snap_pixel (implemented; event-specific logical requirements) | snap_conversions_api_v3 (active; event-specific logical requirements) | Utekos-owned Snap Pixel and Conversions API v3 outbox are active. |
...
| `remove_from_cart` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `view_cart` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `begin_checkout` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned browser bridge dispatches one canonical Meta Pixel call and, when the consent-gated Signals Gateway SDK is enabled, one cbq call for begin_checkout with the same event_id. Canonical Meta CAPI remains the server owner, and the independent manual GTM cbq bridge remains paused. |
...
| `begin_checkout` | `active` | `snapchat` | snap_pixel (implemented; event-specific logical requirements) | snap_conversions_api_v3 (active; event-specific logical requirements) | Utekos-owned Snap Pixel and Conversions API v3 outbox are active. |
...
| `add_shipping_info` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `refund` | `active` | `snapchat` | none | none | No v1 Snapchat refund mapping is approved. |
...
| `search` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `view_search_results` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `view_promotion` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `select_promotion` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `generate_lead` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `form_start` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `form_submit` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `form_error` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `filter_apply` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `sort_apply` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `variant_select` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `payment_error` | `blocked_source` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `scroll_depth` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `view_category` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `hero_interact` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `interact_with_accordion` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `open_quick_view` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
...
| `video_progress` | `active` | `snapchat` | none | none | No v1 Snapchat conversion mapping is approved. |
| `meta_app_event` | `active` | `supabase` | none | first_party_api (disabled; canonicalEnvelope) | Authenticated source events are persisted in the canonical ledger. |
| `meta_app_event` | `active` | `google` | none | none | Source-specific Meta events are not exported to Google. |
| `meta_app_event` | `active` | `meta` | none | meta_conversions_api_app (active; metaServer) | Meta Business SDK v26 outbox delivery is active for authenticated, consent-qualified source events. |
| `meta_app_event` | `active` | `microsoft_uet` | none | none | Source-specific Meta events are not exported to Microsoft UET. |
| `meta_app_event` | `active` | `pinterest` | none | none | Source-specific Meta events are not exported to Pinterest. |
| `meta_app_event` | `active` | `snapchat` | none | none | Source-specific Meta events are not exported to Snapchat. |
| `meta_offline_event` | `active` | `supabase` | none | first_party_api (disabled; canonicalEnvelope) | Authenticated source events are persisted in the canonical ledger. |
| `meta_offline_event` | `active` | `google` | none | none | Source-specific Meta events are not exported to Google. |
| `meta_offline_event` | `active` | `meta` | none | meta_conversions_api_offline (active; metaServer) | Meta Business SDK v26 outbox delivery is active for authenticated, consent-qualified source events. |
| `meta_offline_event` | `active` | `microsoft_uet` | none | none | Source-specific Meta events are not exported to Microsoft UET. |
| `meta_offline_event` | `active` | `pinterest` | none | none | Source-specific Meta events are not exported to Pinterest. |
| `meta_offline_event` | `active` | `snapchat` | none | none | Source-specific Meta events are not exported to Snapchat. |
