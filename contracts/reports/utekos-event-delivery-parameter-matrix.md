...
| `page_view` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel is the sole browser event owner and the canonical Meta CAPI outbox is the sole server event owner. Signals Gateway browser transport and the manual GTM cbq bridge are disabled, and historical blocked rows remain excluded from blind replay. |
...
| `view_item` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel is the sole browser event owner and the canonical Meta CAPI outbox is the sole server event owner. Signals Gateway browser transport and the manual GTM cbq bridge are disabled. |
...
| `add_to_cart` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel is the sole browser event owner for add_to_cart and the canonical Meta CAPI outbox is the sole server event owner. Signals Gateway browser transport and the manual GTM cbq bridge are disabled. |
...
| `begin_checkout` | `active` | `meta` | meta_pixel (implemented; metaBrowser) | meta_conversions_api (active; metaServer) | The app-owned Meta Pixel is the sole browser event owner for begin_checkout and the canonical Meta CAPI outbox is the sole server event owner. Signals Gateway browser transport and the manual GTM cbq bridge are disabled. |
