...
export const canonicalFilterApplyCustomDataSchema =
  z.strictObject({
...
export const canonicalFilterApplySchema = z.strictObject({
...
export type CanonicalFilterApply = z.infer<
  typeof canonicalFilterApplySchema
>
