...
export function HeroImage() {
  return (
    <div
      className={cn(
        'group relative mx-auto mb-0 w-full max-w-none overflow-hidden rounded-2xl border border-foreground/12 shadow-none sm:mb-12 sm:max-w-6xl sm:shadow-[0_28px_70px_-44px_color-mix(in_oklab,var(--card)_80%,transparent)] lg:mb-16'
      )}
    >
