      ...
      <div className='relative'>
        ...
        >
          ...
          <CarouselPrevious
            ...
            className="absolute top-1/2 left-2 z-20 size-8 -translate-y-1/2 cursor-pointer border border-sidebar-foreground bg-sidebar text-sidebar-foreground shadow-none transition-colors after:absolute after:-inset-1.5 after:content-[''] hover:bg-sidebar hover:text-sidebar-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sidebar-foreground sm:left-3 sm:size-10 [&_svg]:size-3.5! sm:[&_svg]:size-4!"
          />

          <CarouselNext
            aria-label='Neste produktbilde'
            className="absolute top-1/2 right-2 z-20 size-8 -translate-y-1/2 cursor-pointer border border-sidebar-foreground bg-sidebar text-sidebar-foreground shadow-none transition-colors after:absolute after:-inset-1.5 after:content-[''] hover:bg-sidebar hover:text-sidebar-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sidebar-foreground sm:right-3 sm:size-10 [&_svg]:size-3.5! sm:[&_svg]:size-4!"
          />
        </Carousel>
      </div>
