...
export function ProductCardHeader({
  ...
  return (
    <CardHeader
      className={cn(
        'relative z-10 -mt-6 flex grow flex-col gap-3 rounded-t-3xl border-t border-border bg-night p-6 pb-4',
    ...
    >
      ...
      >
        <Link
          ...
          title={title}
          className={cn(
            'w-full min-w-0 rounded-sm font-sans font-semibold focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-card-foreground'
          )}
        >
          <CardTitle
            className={cn(
