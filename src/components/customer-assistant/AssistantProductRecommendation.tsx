    ...
    <article className='overflow-hidden rounded-2xl border border-border bg-card text-card-foreground'>
      ...
      <div className='space-y-4 p-4'>
        <div className='flex items-start justify-between gap-4'>
          <div>
            <p className='mb-1 font-sans font-semibold text-xs tracking-wide text-card-foreground/70 uppercase'>
        ...
        <div className='flex flex-col gap-2 sm:flex-row'>
          <Link
            href={productHref}
            className='hover:bg-primary-hover inline-flex min-h-11 flex-1 items-center justify-center gap-2 rounded-xl bg-primary px-4 py-2.5 font-sans font-semibold text-sm text-primary-foreground transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring motion-reduce:transition-none'
          >
            Se produkt
            <ArrowRightIcon
              className='size-4'
