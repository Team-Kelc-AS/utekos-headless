...
export function FeaturedProductsSkeleton() {
  return (
    ...
    >
      <div className='relative mx-auto w-full border-t border-t-foreground/30 px-[var(--product-rail)] pt-20 pb-[calc(--spacing(20)+--spacing(5))] [--product-rail:1rem] sm:pt-24 sm:pb-[calc(--spacing(24)+--spacing(5))] sm:[--product-rail:1.5rem] md:pt-28 md:pb-[calc(--spacing(28)+--spacing(5))] md:[--product-rail:clamp(3rem,7.42vw,4.75rem)] lg:pt-32 lg:pb-[calc(--spacing(32)+--spacing(5))] xl:[--product-rail:6rem]'>
