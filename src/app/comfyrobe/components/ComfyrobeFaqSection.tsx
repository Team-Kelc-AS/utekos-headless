  ...
  return (
    ...
    >
      <div className='mx-auto max-w-4xl px-6 md:px-12'>
        ...
        <h2
          id='faq-heading'
          className='mt-3 text-center font-sans text-4xl leading-[0.94] font-bold tracking-[-0.025em] md:text-6xl'
        >
          Trygg på valget.
        </h2>
        ...
        <div className='mt-12 divide-y divide-border border-y border-border'>
          {COMFYROBE_LANDING_FAQ.map(item => (
            <details key={item.question} className='group py-2'>
              <summary className='cursor-pointer list-none rounded-lg py-5 font-sans text-lg font-semibold focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary'>
        ...
        >
          <Link
            ...
            className='min-h-11 content-center font-semibold underline underline-offset-4'
          >
            Se størrelsesguide
          </Link>
          <Link
