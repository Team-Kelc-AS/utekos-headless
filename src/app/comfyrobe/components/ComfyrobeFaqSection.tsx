  ...
  return (
    ...
    >
      <div className='mx-auto max-w-4xl rounded-xl bg-jungle px-6 py-12 md:px-12'>
        ...
        <h2
          id='faq-heading'
          className='font-google-sans mt-3 text-center font-sans text-4xl leading-[0.94] font-bold tracking-tight md:text-6xl'
        >
        ...
        <div className='mt-12 divide-y divide-border border-y border-border'>
          {COMFYROBE_LANDING_FAQ.map(item => (
            <details key={item.question} className='group py-2'>
              <summary className='cursor-pointer list-none rounded-lg py-5 font-sans text-lg focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary'>
