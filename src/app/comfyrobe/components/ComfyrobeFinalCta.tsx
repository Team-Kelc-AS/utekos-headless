    ...
    >
      ...
      >
        ...
        <m.h2
          ...
          className='mx-auto mt-3 max-w-[12ch] font-sans text-4xl leading-[0.94] font-bold tracking-[-0.025em] md:text-6xl'
          variants={comfyrobeRevealItem}
        >
        ...
        <m.div className='mt-8' variants={comfyrobeRevealItem}>
          <BrandBadge
            ...
            className='min-h-13 px-7 py-3 font-semibold transition-[filter,transform] hover:brightness-105 active:scale-[0.985]'
          >
            <button
              type='button'
