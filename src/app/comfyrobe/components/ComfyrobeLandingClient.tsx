...
export function ComfyrobeLandingClient({
  ...
  const primaryLabel =
    ...
    : offer ?
      `Se størrelser – ${offer.priceLabel}`
    : 'Se tilgjengelighet'
  const offerDetails = [
    offer?.compareAtPriceLabel ?
      `Før ${offer.compareAtPriceLabel}`
    : null,
    offer?.savingsAmountLabel && offer.savingsPercentage !== null ?
          ...
          <div className='relative z-10 mx-auto flex min-h-[calc(100svh-70px)] w-full max-w-350 items-end px-6 py-8 md:items-center md:px-12 md:py-20 lg:px-20'>
            ...
            >
              ...
              <m.h1
                ...
                className='max-w-[10ch] font-sans text-[clamp(2.75rem,12vw,3.75rem)] leading-[0.9] font-bold tracking-tight text-white md:text-6xl lg:text-7xl'
                variants={comfyrobeRevealItem}
              >
                Tøff mot været.
              ...
              <m.p
                ...
                variants={comfyrobeRevealItem}
              >
                Vanntett og vindtett på utsiden. SherpaCore™ på innsiden. En romslig allværskåpe
                for regn, hundeturen, sidelinjen og kalde dager.
              </m.p>
              ...
              >
                <BrandBadge
                  ...
                  className='min-h-13 w-full gap-2 px-6 py-3 font-semibold transition-[filter,transform] hover:brightness-105 active:scale-[0.985] sm:w-auto'
                >
                  <button
                    type='button'
