    ...
    <aside className='w-full lg:col-span-4'>
      <div className='sticky top-28 mt-4 flex min-w-0 flex-col rounded-2xl bg-night p-2'>
        <div className='flex flex-col items-start rounded-xl border border-border bg-jungle p-6 text-card-foreground shadow-sm ring-1 ring-border sm:p-8'>
          <h2 className='mb-8 text-left font-sans font-semibold text-xl leading-tight text-card-foreground'>
          ...
          <ul className='flex w-full flex-col gap-6'>
            <li className='flex items-start gap-4'>
              ...
              <div className='flex flex-col items-start'>
                <span className='font-sans font-semibold text-base text-card-foreground'>
                  14 dagers angrerett
                </span>
                <span className='mt-1 text-left font-sans text-sm leading-relaxed text-card-foreground/90'>
            ...
            <li className='flex items-start gap-4'>
              ...
              <div className='flex flex-col items-start'>
                ...
                <address className='mt-1 not-italic'>
                  <span className='text-left font-sans text-sm leading-relaxed text-card-foreground/90'>
          ...
          <div className='flex w-full flex-col items-start'>
            <h3 className='mb-4 text-left font-sans font-semibold text-base text-card-foreground'>
              Start en retur
            </h3>
            <a
              href={`mailto:${returnPolicy.contactEmail}`}
              data-track='ShippingReturnsSidebarEmailClick'
              className='mb-3 font-sans font-semibold text-sm text-card-foreground underline decoration-card-foreground/30 underline-offset-4 hover:decoration-card-foreground'
            >
