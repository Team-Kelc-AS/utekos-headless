    ...
    >
      <div className='mx-auto max-w-5xl'>
        <div className='mb-10 text-center'>
          <p className='mb-3 font-sans font-semibold text-sm tracking-wide text-primary uppercase'>
            Passform
          </p>
          <h2
          ...
          <p className='mx-auto mt-4 max-w-2xl font-sans text-base leading-relaxed text-foreground/80 md:text-lg'>
        ...
        <p className='mt-6 text-center font-sans text-sm text-foreground/70'>
          Trenger du mer detaljer?{' '}
          <a
            href='/handlehjelp/storrelsesguide#comfyrobe-size-guide'
            className='font-sans font-semibold text-foreground underline underline-offset-4 hover:text-primary'
          >
