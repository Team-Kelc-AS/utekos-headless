...
export const choicePillClass =
  'inline-flex min-h-12 min-w-0 items-center justify-center whitespace-nowrap rounded-full px-1.5 py-2 text-center text-[10px] font-sans font-semibold leading-none tracking-normal transition-all sm:px-4 sm:text-sm sm:leading-[1.15] md:text-base'
