  ...
  const klarnaPurchaseAmount =
    ...
    return (
      <section
        ...
        className='bg-background relative min-h-[calc(100svh-70px)] w-full overflow-hidden font-sans text-foreground xl:min-h-[calc(100svh-86px)]'
      >
      ...
      />
      <div className='relative z-10 mx-auto flex min-h-[calc(100svh-70px)] w-full max-w-350 flex-col items-start justify-start px-6 pt-4 pb-8 md:justify-center md:px-12 md:pt-24 md:pb-16 lg:px-20 xl:min-h-[calc(100svh-86px)]'>
        <div className='max-w-2xl'>
          <div
            className='mb-1 aspect-1281/312 h-9 text-foreground drop-shadow-lg sm:h-14 md:mb-6 md:h-16 lg:h-20'
            aria-hidden='true'
          >
          ...
          <h1
            id='hero-headline'
            className='text-left font-sans text-3xl leading-[0.92] font-bold tracking-[-0.01em] drop-shadow-lg sm:text-5xl md:text-6xl lg:text-7xl'
          >
            <span className='block whitespace-nowrap text-foreground'>
              Skreddersy varmen.
            </span>
            <span className='mt-1 block max-w-4xl text-left font-sans text-3xl font-bold text-primary italic sm:text-4xl md:mt-3 md:text-5xl lg:text-6xl'>
              Forleng kvelden.
            </span>
          </h1>

          <p className='leading-text-paragraph mt-2 max-w-xl font-sans text-base tracking-tight text-foreground/90 drop-shadow-md md:mt-7 md:text-lg lg:text-xl'>
