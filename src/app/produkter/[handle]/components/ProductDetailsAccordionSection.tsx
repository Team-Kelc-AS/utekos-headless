...
export function ProductDetailsAccordionSection({
  ...
  return (
    <details
      ...
      className='group border-coral-green relative overflow-hidden rounded-xl border-b bg-jungle text-card-foreground transition-colors duration-200 hover:cursor-pointer open:border-card-foreground/24 open:bg-jungle'
    ...
    >
      <summary className='relative z-10 flex min-h-14 list-none items-center justify-between bg-jungle px-5 py-4 text-card-foreground transition-colors duration-200 hover:text-card-foreground focus-visible:ring-2 focus-visible:ring-card-foreground/45 focus-visible:outline-none group-open:text-card-foreground sm:px-6 [&::-webkit-details-marker]:hidden'>
        <span className='flex items-center gap-4'>
          <span
            className='flex size-10 items-center justify-center rounded-full border border-card-foreground/24 bg-card text-card-foreground transition-transform duration-200 group-hover:scale-105'
      ...
      <div className='pointer-events-none absolute inset-0 z-0 bg-background/0 transition-colors duration-200 group-hover:cursor-pointer group-hover:bg-card-foreground/8 group-open:bg-card-foreground/8 ' />
