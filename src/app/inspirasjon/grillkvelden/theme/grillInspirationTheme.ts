...
export const grillCtaTheme = {
  ...
  primaryButtonClassName:
    'group min-h-14 border border-secondary/35 dark:border-dark-secondary/35 px-8 py-4 text-base leading-4 font-google-sans font-bold tracking-normal shadow-[0_18px_38px_-28px_color-mix(in_oklch,var(--demitasse)_72%,transparent)] transition-transform duration-300 hover:-translate-y-0.5 hover:brightness-105',
