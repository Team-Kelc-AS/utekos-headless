...
| `add_payment_info`    | blocked_source | `payment_info_submitted` proves submission, not an accepted payment revision         | rejected Shopify Customer Events/Web Pixels candidate                        | declared only                          | disabled                              | `AddPaymentInfo` planned | disabled                              | checkout/payment revision missing  | not active                                                                       |
