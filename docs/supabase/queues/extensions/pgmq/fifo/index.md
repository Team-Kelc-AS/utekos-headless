...
Upstream: [fifo](https://pgmq.github.io/pgmq/latest/fifo-queues/).
...
See [`examples/fifo_example.sql`](https://github.com/pgmq/pgmq/blob/main/examples/fifo_example.sql) for comprehensive usage examples.
