...
Local mirror under `docs/supabase/queues/extensions/pgmq/`. Upstream snapshot:
[`pgmq-extension/README.md`](https://github.com/pgmq/pgmq/blob/main/pgmq-extension/README.md).

### Local docs

- [Types](./types.md)
- [Functions](./functions/index.md)
- [FIFO queues](./fifo/index.md)
- [Topic-based routing](./topics.md)
- [Partitioned queues](./partitioned-queues.md)
- [Supabase Queues overview](../../README.md)
- [Supabase Queues quickstart](../../queues-start.md)

![pgmq demo gif](https://github.com/user-attachments/assets/3e6d23c5-83fa-4c4a-98ae-77f305e3cd5c)
...
- [FIFO](./fifo/index.md) (First-In-First-Out) queues with message group keys for ordered processing
- [Topic-based](./topics.md) routing with wildcard patterns for publish-subscribe and content-based routing
...
[UPDATING.md](https://github.com/pgmq/pgmq/blob/main/pgmq-extension/UPDATING.md).
...
- [Python](https://github.com/pgmq/pgmq-py) — [docs](https://pgmq.github.io/pgmq-py/)
...
- [JavaScript (Node.js)](https://github.com/Muhammad-Magdi/pgmq-js)
...
- [Python (SQLAlchemy)](https://github.com/jason810496/pgmq-sqlalchemy)
...
- [TypeScript (Node.js + Prisma)](https://github.com/dvlkv/prisma-pgmq)
- [TypeScript (Node.js + Midway.js)](https://github.com/waitingsong/pgmq-js)
...
[![pgmq contributors](https://contrib.rocks/image?repo=pgmq/pgmq)](https://github.com/pgmq/pgmq/graphs/contributors)
