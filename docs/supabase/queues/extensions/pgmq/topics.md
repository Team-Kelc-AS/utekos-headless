...
Upstream: [topics](https://pgmq.github.io/pgmq/latest/topics/).
...
See [`examples/topics.sql`](https://github.com/pgmq/pgmq/blob/main/examples/topics.sql) for comprehensive usage examples including:
